...
### Method 14: call this method when ever synchronous call is returning list data or class,if you want to update the data at later point register this call on every screen. so it will trigger the update for each UI call
